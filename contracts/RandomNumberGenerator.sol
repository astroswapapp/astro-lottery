...
import "./interfaces/IAstroSwapLottery.sol";

contract RandomNumberGenerator is IRandomNumberGenerator, Ownable {
    using SafeERC20 for IERC20;

    address public astroSwapLottery;
    ...
    function getRandomNumber(uint256 _seed) external override {
        require(msg.sender == astroSwapLottery, "Only AstroSwapLottery");
     ...
     * @param _astroSwapLottery: address of the PancakeSwap lottery
     */
    function setLotteryAddress(address _astroSwapLottery) external onlyOwner {
        astroSwapLottery = _astroSwapLottery;
    }
    ...
    function fulfillRandomness() external {
        ...
        latestLotteryId = IAstroSwapLottery(astroSwapLottery).viewCurrentLotteryId();
    }
}
